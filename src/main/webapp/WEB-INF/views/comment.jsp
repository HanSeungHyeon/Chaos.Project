							...
							if (data.length > 0) {
								$.each(data, function(index, item){
									if(item.status=='0'){
										...
										if(item.pname == "N"){
										html += "<img class='rounded-circle' width='30'	src='${pageContext.request.contextPath}/resources/images/default.png' alt='' />	</div> <div class='col-md-10' style='margin-bottom:10px'>";
										}else{
									    html += "<img class='rounded-circle' width='30'	src='${pageContext.request.contextPath}/download?filename="+item.pname+"' style='height:30px' alt='' />	</div> <div class='col-md-10' style='margin-bottom:10px'>";											
										}
										html += "<a class='float-left' href='#'><strong>@"
												+ item.writer + "</strong></a>";
										html += "<div id='"+item.rnum+"cv'&nbsp;&nbsp;&nbsp;&nbsp; >" + item.comment +"</div>";
				...
				success : function(data) {
					...
					if (data.length > 0) {
						$.each(data, function(index, item){
							...
							if(item.pname == "N"){
							html += "<img class='rounded-circle' width='20' src='${pageContext.request.contextPath}/resources/images/default.png' alt='' />	</div> <div class='col-md-10' style='margin-bottom:10px'>";
							}else{
						    html += "<img class='rounded-circle' width='20' style='height:20px' src='${pageContext.request.contextPath}/download?filename="+item.pname+"' alt='' />	</div> <div class='col-md-10' style='margin-bottom:10px'>";
							}
							html += "<a class='float-left' href='#'><strong>@"
									+ item.writer + "</strong></a>";
							html += "<div id='"+item.rnum+"cv'&nbsp;&nbsp;&nbsp;&nbsp; >" + item.comment +"</div>";
